...
public class GamePanel extends JPanel implements KeyListener, MouseListener, MouseMotionListener  {
	...
	public GamePanel() {
		UnitCollection.get().add(new Harvester(2 * Block.SIZE, 3 * Block.SIZE));
		UnitCollection.get().add(new Harvester(5 * Block.SIZE, 1 * Block.SIZE));
		UnitCollection.get().add(new Harvester(25 * Block.SIZE, 10 * Block.SIZE));
